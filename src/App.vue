...
.keyboard-row:first-child .keycap span { font-size: clamp(4.5px,.78cqw,8.5px); letter-spacing: -.03em; }.keycap.side { padding: .5cqw .4cqw; border-radius: .28cqw; min-width: 0; }.keycap.side span { font-size: clamp(5.5px,.95cqw,9px); }.keycap.side b { font-size: clamp(5px,.9cqw,8.5px); }.kb-side { display: flex; gap: 1cqw; flex: 0 0 auto; align-items: start; }
