...
.runtime-warning { position: relative; z-index: 1; display: flex; align-items: center; gap: 10px; max-width: 1480px; margin: -54px auto 35px; padding: 11px 14px; border: 1px solid rgba(255,209,102,.28); border-radius: 12px; color: #ffd166; background: rgba(84,64,31,.3); }.runtime-warning > span { display: grid; place-items: center; width: 18px; height: 18px; border-radius: 50%; color: #17120a; background: #ffd166; font-size: 11px; font-weight: 900; }.runtime-warning b, .runtime-warning small { display: block; }.runtime-warning b { font-size: 11px; }.runtime-warning small { margin-top: 3px; color: #c1a968; font-size: 10px; }
.privacy-backdrop { position: fixed; z-index: 20; inset: 0; display: grid; place-items: center; padding: 22px; background: rgba(4,9,24,.72); backdrop-filter: blur(8px); }.privacy-dialog { width: min(100%, 520px); max-height: min(680px, calc(100vh - 44px)); overflow: auto; padding: 26px; border: 1px solid rgba(52,217,255,.25); border-radius: 20px; background: linear-gradient(145deg, #192956, #101a39); box-shadow: 0 28px 80px rgba(0,0,0,.45); }.privacy-dialog-heading { display: flex; align-items: start; justify-content: space-between; gap: 18px; }.privacy-dialog h3 { margin: 5px 0 0; font-size: 22px; letter-spacing: -.05em; }.privacy-close { width: 30px; height: 30px; border: 1px solid rgba(148,163,184,.2); border-radius: 50%; color: #a9b6cc; background: rgba(148,163,184,.1); cursor: pointer; font-size: 20px; line-height: 1; }.privacy-close:hover { color: #fff; border-color: rgba(52,217,255,.65); }.privacy-intro { margin: 22px 0 18px; color: #d7e0f0; font-size: 13px; line-height: 1.65; }.privacy-points { display: grid; gap: 10px; }.privacy-points article { display: grid; grid-template-columns: 29px 1fr; gap: 11px; padding: 13px; border: 1px solid rgba(148,163,184,.13); border-radius: 12px; background: rgba(8,16,35,.28); }.privacy-points article > span { color: #34d9ff; font-size: 10px; font-weight: 900; }.privacy-points b, .privacy-points small { display: block; }.privacy-points b { margin-bottom: 4px; color: #f8fafc; font-size: 11px; }.privacy-points small { color: #91a0bc; font-size: 10px; line-height: 1.55; }.privacy-notice { display: grid; gap: 5px; margin-top: 14px; padding: 13px; border-left: 3px solid #ffd166; color: #c1a968; background: rgba(255,209,102,.07); font-size: 10px; line-height: 1.55; }.privacy-notice b { color: #ffd166; }.privacy-storage { display: grid; gap: 6px; margin-top: 17px; color: #71819d; font-size: 9px; }.privacy-storage code { overflow-wrap: anywhere; color: #a9b6cc; font-family: ui-monospace, SFMono-Regular, Consolas, monospace; font-size: 9px; }
