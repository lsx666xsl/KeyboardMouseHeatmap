...
<style scoped>
.pk-backdrop { position: fixed; z-index: 30; inset: 0; display: grid; place-items: start center; padding: max(24px, 9vh) 22px 22px; background: rgba(4, 9, 24, .6); backdrop-filter: blur(8px); }
.pk-modal { width: min(100%, 460px); max-height: calc(100vh - max(28px, 9vh) - 46px); overflow: auto; padding: 22px; border: 1px solid rgba(var(--cyan-rgb), .25); border-radius: 20px; background: linear-gradient(145deg, rgba(var(--panel-rgb), .98), rgba(var(--pop-rgb), .98)); box-shadow: 0 26px 80px rgba(0, 0, 0, .45); }
